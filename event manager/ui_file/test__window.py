...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.event_des_label = QtWidgets.QLabel("Event Description/Notes:", self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        self.event_des_label.setFont(font)
        self.event_des_label.setStyleSheet("color: white;")
        left_layout.addWidget(self.event_des_label)

        self.event_description = QtWidgets.QTextEdit(self.centralwidget)
        self.event_description.setReadOnly(True)
        left_layout.addWidget(self.event_description)
